...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2017 at 06:29 PM
...
('CSE-1103', '', '2012-13', '1st', '170202', '102', 25),
('CSE-1103', '', '2012-13', '1st', '170202', '103', 32),
...
('CSE-3200', '', '2013-14', '6th', '140202', '102', 30),
('CSE-3200', '', '2013-14', '6th', '140202', '103', 40),
...
('CSE-1105', '', '2012-13', '1st', '110201', '101', 50),
('CSE-1105', '', '2012-13', '1st', '110201', '102', 45),
('CSE-1105', '', '2012-13', '1st', '110202', '101', 30),
('CSE-1105', '', '2012-13', '1st', '110202', '102', 30);
...
('CSE-1103', NULL, '1st', '2012-13', '170202', '72', ' A-', '3.5'),
('CSE-1103', NULL, '1st', '2012-13', '170222', '80', ' A+', '4'),
('CSE-1103', NULL, '1st', '2012-13', '170233', '50', ' C+', '2.5'),
('CSE-3200', NULL, '6th', '2013-14', '140202', '110', ' ', ''),
('CSE-3200', NULL, '6th', '2013-14', '140224', '12', ' F', '0'),
('CSE-1105', NULL, '1st', '2012-13', '110201', '95', 'A+', '4'),
('CSE-1105', NULL, '1st', '2012-13', '110202', '60', 'B', '3');
...
--
-- Table structure for table `tbl_retake_marks`
--

CREATE TABLE `tbl_retake_marks` (
  `ID` int(11) NOT NULL,
  `RetakeMarks` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_retake_marks`
--

INSERT INTO `tbl_retake_marks` (`ID`, `RetakeMarks`) VALUES
(1, -5);
...
--
-- Indexes for table `tbl_retake_marks`
--
ALTER TABLE `tbl_retake_marks`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `tbl_retake_marks`
--
ALTER TABLE `tbl_retake_marks`
